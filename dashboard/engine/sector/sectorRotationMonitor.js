...
export async function analyzeSectorRotation({
  ...
  // API base URL (caller can pass this to override DEFAULT_API_BASE)
  ...
  // Resolve historyEndpoint from apiBase if not explicitly provided
  if (!historyEndpoint) {
    historyEndpoint = `${apiBase}/api/history`;
  }
